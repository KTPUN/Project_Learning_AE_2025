...
public class HP_Women_Category 
{
	WebDriver driver;
		
	public HP_Women_Category(WebDriver driver) 
	{
		this.driver=driver;
	}
	
	public void click_category_women() throws Exception
	{
		driver.findElement(By.xpath(ReadPropFiles.readelement("HomePage_category_women_xpath"))).click();
	}
	
	public void click_sub_category_dress() throws Exception
	{
		driver.findElement(By.xpath(ReadPropFiles.readelement("HomePage_sub_category_dress_xpath"))).click();
	}
