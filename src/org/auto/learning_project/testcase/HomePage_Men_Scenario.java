...
import org.auto.learning_project.pages.HP_Men_Category;
...
public class HomePage_Men_Scenario extends InitializeBrowser
{
	...
	public void tc04_valid_Men_homepagefunc() throws Exception
	{
      LoginPage login = new LoginPage(driver);
		...
		HP_Men_Category  homepg = new HP_Men_Category(driver);
		
		Thread.sleep(3000);
		homepg.click_category_men();
		Thread.sleep(3000);
		homepg.click_sub_category_Tshirt();
		Thread.sleep(3000);
